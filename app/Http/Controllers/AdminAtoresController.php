...
class AdminAtoresController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
			...
			$this->index_statistic[] = ['label'=>'Total Atores','count'=>DB::table('Atores')->count(),'icon'=>'fa fa-users','color'=>'success'];
