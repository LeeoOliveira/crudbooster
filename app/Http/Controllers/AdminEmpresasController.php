<?php namespace App\Http\Controllers;
	...
	class AdminEmpresasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Nome Empresa","name"=>"nome"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nome Empresa','name'=>'nome','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
            $this->form[] = ['label'=>'CNPJ','name'=>'cnpj','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
            $this->form[] = ['label'=>'Representante','name'=>'representante','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
            ...
            $this->form[] = ['label'=>'Observação','name'=>'observacoes','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
