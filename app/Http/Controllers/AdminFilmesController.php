...
class AdminFilmesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Atores","name"=>"id", "join"=>"atores,nome"];
			...
			$this->form[] = ['label'=>'Nome','type'=>'text','name'=>'nome'];
            $this->form[] = ['label'=>'Atores','type'=>'select2','datatable'=>'atores,nome','relationship_table'=>'filmes_atores', 'name'=>'filmes_atores'];
			$this->form[] = ['label'=>'Descrição','type'=>'textarea','name'=>'descricao'];
            //
	        ...
	        */
			...
			$this->index_statistic[] = ['label'=>'Total Filmes','count'=>DB::table('filmes')->count(),'icon'=>'fa fa-users','color'=>'success'];
			$this->index_statistic[] = ['label'=>'Total de Atores','count'=>DB::table('atores')->count(),'icon'=>'fa fa-check','color'=>'success'];
